// this module is fork of https://github.com/JuxhinDB/synner
...
pub mod packet {
    ...
    use self::pnet_datalink::{Channel, MacAddr, NetworkInterface};
    use self::pnet_packet::ethernet::{EtherTypes, MutableEthernetPacket};
    use self::pnet_packet::ip::IpNextHeaderProtocols;
    use self::pnet_packet::ipv4::{Ipv4Flags, MutableIpv4Packet};
    ...
    pub fn send_tcp_packets(destination_ip: Ipv4Addr, interface: String) {
